...
void H_LCD_voidSendCustomCharacter(u8 *Copy_pu8CharacterArray, u8 Copy_u8PatternNumber,  u8 Copy_u8Xposition,  u8 Copy_u8Yposition)
{
	...
	SET_BIT(Local_u8CGRAMAddress ,6);
	 H_LCD_void_sendCommand(Local_u8CGRAMAddress);
	for(Local_u8LoopCounter=0 ; Local_u8LoopCounter <8;Local_u8LoopCounter++)
	{
		H_LCD_void_sendData(Copy_pu8CharacterArray[Local_u8LoopCounter]);
	}
	H_LCD_void_gotXY(Copy_u8Xposition,Copy_u8Yposition);
	H_LCD_void_sendData(Copy_u8PatternNumber);
}
